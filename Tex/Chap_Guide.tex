...
\begin{figure}
	\subfigure[original]{
		\begin{minipage}[b]{0.25\linewidth}
			\includegraphics[width=1\textwidth]{pic/fast_img/2/result/img_original_2_0.3.jpg}
		\end{minipage}
		\hspace{-12pt}
	}
	\subfigure[LRMC]{
		\begin{minipage}[b]{0.25\linewidth}
			\includegraphics[width=1\textwidth]{pic/fast_img/2/result/rpca_image_recovered_2_0.3.jpg}
		\end{minipage}
		\hspace{-12pt}
	} 
	\subfigure[SNN]{
		\begin{minipage}[b]{0.25\linewidth}
			\includegraphics[width=1\textwidth]{pic/fast_img/2/result/snn_image_recovered_2_0.3.jpg}
		\end{minipage}
		\hspace{-12pt}
	} 
	\subfigure[t-TNN]{
		\begin{minipage}[b]{0.25\linewidth}
			\includegraphics[width=1\textwidth]{pic/fast_img/2/result/ttnn_image_recovered_2_0.3.jpg}
		\end{minipage}
		\hspace{-12pt}
	}
	\subfigure[TCTF]{
		\begin{minipage}[b]{0.25\linewidth}
			\includegraphics[width=1\textwidth]{pic/fast_img/2/result/TCTF_img_recovered_2_0.3.jpg}
		\end{minipage}
		\hspace{-12pt}
	}
	\subfigure[PSTNN]{
		\begin{minipage}[b]{0.25\linewidth}
			\includegraphics[width=1\textwidth]{pic/fast_img/2/result/pstnn_img1.jpg}
		\end{minipage}
		\hspace{-12pt}
	}
	\subfigure[TC-RE]{
		\begin{minipage}[b]{0.25\linewidth}
			\includegraphics[width=1\textwidth]{pic/fast_img/2/result/tcre_img1.jpg}
		\end{minipage}
		\hspace{-12pt}
	}
	\subfigure[TCDLR-RE]{
	...
	\bicaption{ 这里用了本人论文里的一组对照图，供各位参考 }
